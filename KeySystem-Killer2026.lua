...
local correctKey = "killer2026"
local realScript = "https://raw.githubusercontent.com/ywxoscripts/lua/refs/heads/main/1489026993.lua"
local keyLink    = "https://direct-link.net/1349827/Mi0BwLmDxCJb"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysKiller" 
