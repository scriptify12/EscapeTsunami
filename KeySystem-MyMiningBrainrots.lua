-- Key system wrapper for My Mining Brainrots script ──────────────────────────────────────────────

local correctKey = "brainrot2026"
local realScript = "https://raw.githubusercontent.com/gumanba/Scripts/main/MyMiningBrainrots"
local keyLink    = "https://link-target.net/1349827/jJzqfD5xwTQK"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysMiningBrainrots" 
