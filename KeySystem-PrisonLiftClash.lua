-- Key system wrapper for Prison Lift Clash script ──────────────────────────────────────────────

local correctKey = "prison2026"
local realScript = "https://raw.githubusercontent.com/gumanba/Scripts/main/PrisonLiftClash"
local keyLink    = "https://link-hub.net/1349827/CqEPrJ05cHs9"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysPrison" 
