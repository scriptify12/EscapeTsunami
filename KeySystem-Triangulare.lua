-- Key system wrapper for Triangulare script hub ──────────────────────────────────────────────

local correctKey = "human2026"
local realScript = "https://raw.githubusercontent.com/Moligrafi001/Triangulare/main/Loader.lua"
local keyLink    = "https://link-hub.net/1349827/MYq8SDDk0UuY"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysTriangulare" 
