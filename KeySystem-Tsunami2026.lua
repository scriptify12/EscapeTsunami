local correctKey = "tsunami2026"
local realScript = "https://raw.githubusercontent.com/gumanba/Scripts/main/EscapeTsunamiForBrainrots"
local keyLink    = "https://link-center.net/1349827/6I5DGUfnS8Io"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysTsunami" 
