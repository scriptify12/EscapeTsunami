...
local correctKey = "youtubers2026"
local realScript = "https://raw.githubusercontent.com/scriptyyz/roblox/refs/heads/main/BeAYoutuber.lua"
local keyLink    = "https://loot-link.com/s?53QdRN9i"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysYoutuber" 
