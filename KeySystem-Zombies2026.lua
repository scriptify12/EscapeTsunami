...
local correctKey = "zombies2026"
local realScript = "https://raw.githubusercontent.com/scriptyyz/roblox/refs/heads/main/FightYourZombie.lu"
local keyLink    = "https://direct-link.net/1349827/6SAXSPBL7LAB"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysZombies" 
