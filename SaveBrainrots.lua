...
local correctKey = "backroom001"
local realScript = "https://raw.githubusercontent.com/gumanba/Scripts/main/SaveBrainrotsFromBackrooms"
local keyLink    = "https://link-target.net/1349827/8zoBfPDJ4OVb"

local setclip = setclipboard or toclipboard or (Clipboard and Clipboard.set) or function() end

local sg = Instance.new("ScreenGui", game.CoreGui) 
sg.Name = "KeySysBackrooms" 
